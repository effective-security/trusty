...
// source: api/v1/trustypb/cis.proto
...
func request_CertInfoService_Roots_0(ctx context.Context, marshaler runtime.Marshaler, client extTrustypb.CertInfoServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_CertInfoService_Roots_0(ctx context.Context, marshaler runtime.Marshaler, server extTrustypb.CertInfoServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extTrustypb.EmptyRequest
	var metadata runtime.ServerMetadata
...
func RegisterCertInfoServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extTrustypb.CertInfoServiceServer) error {
	...
	mux.Handle("GET", pattern_CertInfoService_Roots_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/trustypb.CertInfoService/Roots")
		if err != nil {
...
func RegisterCertInfoServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterCertInfoServiceHandlerClient(ctx, mux, extTrustypb.NewCertInfoServiceClient(conn))
}

// RegisterCertInfoServiceHandlerClient registers the http handlers for service CertInfoService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "extTrustypb.CertInfoServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "extTrustypb.CertInfoServiceClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "extTrustypb.CertInfoServiceClient" to call the correct interceptors.
func RegisterCertInfoServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extTrustypb.CertInfoServiceClient) error {

	mux.Handle("GET", pattern_CertInfoService_Roots_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/trustypb.CertInfoService/Roots")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
