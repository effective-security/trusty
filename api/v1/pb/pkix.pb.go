...
var file_pkix_proto_rawDesc = []byte{
	...
	0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x2a, 0x29, 0x0a, 0x05,
	0x54, 0x72, 0x75, 0x73, 0x74, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x6e, 0x79, 0x10, 0x00, 0x12, 0x0a,
	0x0a, 0x06, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x50, 0x72,
	0x69, 0x76, 0x61, 0x74, 0x65, 0x10, 0x02, 0x2a, 0x2d, 0x0a, 0x0e, 0x45, 0x6e, 0x63, 0x6f, 0x64,
	0x69, 0x6e, 0x67, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x07, 0x0a, 0x03, 0x50, 0x45, 0x4d,
	0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x44, 0x45, 0x52, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x50,
	0x4b, 0x43, 0x53, 0x37, 0x10, 0x02, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_pkix_proto_goTypes = []interface{}{
	...
	(*Crl)(nil),                 // 5: pb.Crl
	(*X509Name)(nil),            // 6: pb.X509Name
	(*X509Subject)(nil),         // 7: pb.X509Subject
	(*CAConstraint)(nil),        // 8: pb.CAConstraint
	(*CSRAllowedFields)(nil),    // 9: pb.CSRAllowedFields
	(*CertProfile)(nil),         // 10: pb.CertProfile
	(*timestamp.Timestamp)(nil), // 11: google.protobuf.Timestamp
}
var file_pkix_proto_depIdxs = []int32{
	11, // 0: pb.RootCertificate.not_before:type_name -> google.protobuf.Timestamp
	11, // 1: pb.RootCertificate.not_after:type_name -> google.protobuf.Timestamp
	0,  // 2: pb.RootCertificate.trust:type_name -> pb.Trust
	11, // 3: pb.Certificate.not_before:type_name -> google.protobuf.Timestamp
	11, // 4: pb.Certificate.not_after:type_name -> google.protobuf.Timestamp
	3,  // 5: pb.RevokedCertificate.certificate:type_name -> pb.Certificate
	11, // 6: pb.RevokedCertificate.revoked_at:type_name -> google.protobuf.Timestamp
	11, // 7: pb.Crl.this_update:type_name -> google.protobuf.Timestamp
	11, // 8: pb.Crl.next_update:type_name -> google.protobuf.Timestamp
	6,  // 9: pb.X509Subject.names:type_name -> pb.X509Name
	8,  // 10: pb.CertProfile.ca_constraint:type_name -> pb.CAConstraint
	9,  // 11: pb.CertProfile.allowed_fields:type_name -> pb.CSRAllowedFields
