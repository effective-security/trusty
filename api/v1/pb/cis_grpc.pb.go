...
func (c *cISClient) GetRoots(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RootsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.CIS/GetRoots", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cISClient) GetCertificate(ctx context.Context, in *GetCertificateRequest, opts ...grpc.CallOption) (*CertificateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.CIS/GetCertificate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CIS_GetRoots_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func _CIS_GetCertificate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.CIS/GetCertificate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
