...
const (
	...
	JWK1Fingerprint = `SHA256 BA:5D:38:22:AD:3B:BA:52:A7:9E:B7:9B:BF:68:6F:DF:2C:42:1A:05:6F:A0:7B:3C:86:3A:B6:B5:52:B1:DE:67`
...
func TestGetKeyFingerprint(t *testing.T) {
	...
	fp, err := acmemodel.GetKeyFingerprint(jwk)
	require.NoError(t, err)
	assert.Equal(t, JWK1Fingerprint, fp)
}
