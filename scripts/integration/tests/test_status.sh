...
/opt/trusty/bin/trustyctl -D --cfg /opt/trusty/etc/dev/trusty-config.yaml -s $TRUSTY_CA_2 \
...
/opt/trusty/bin/trustyctl -D --cfg /opt/trusty/etc/dev/trusty-config.yaml -s $TRUSTY_CA_1 \
