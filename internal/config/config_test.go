...
func TestTrusty_overrideFrom(t *testing.T) {
	...
	exp.PrivateRoots = o2.PrivateRoots
	require.Equal(t, dest, exp, "Trusty.overrideFrom should have overriden the field PrivateRoots. value now %#v, expecting %#v", dest, exp)
}
